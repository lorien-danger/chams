...
/* ============================================================
   PRODUCTS — defined in src/products.js, imported above
   ============================================================ */
...
function App() {
  ...
  const pageMeta = {
    home: { title: "Cham's Small Meats & Preservatives — Family-Owned Smallgoods, Lismore NSW", desc: "Traditional cured meats and preservatives made the same way for nearly forty years. Supplying independent retailers and hospitality providers across NSW since 1987.", img: "/assets/og/default.png" },
  ...
  const meta = product
    ? { title: `${product.name} — Cham's Small Meats & Preservatives`, desc: product.sub, img: `/assets/og/product-${product.slug}.png` }
